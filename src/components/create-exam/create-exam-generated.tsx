          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="flex items-center gap-3 p-3 border rounded-lg hover:bg-muted/50 transition-colors">
              ...
              <div>
                ...
                >
                  {examData.config.difficulty === "easy" && "Fácil"}
                  {examData.config.difficulty === "medium" && "Médio"}
                  {examData.config.difficulty === "hard" && "Difícil"}
                  {examData.config.difficulty === "mixed" && "Misto"}
                </Badge>
              </div>
            </div>
          </div>
