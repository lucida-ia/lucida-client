...
export const PRICING_PLANS = [
  {
    name: "Mensal",
    description: "Para quem quer começar com flexibilidade",
    features: [
    ...
    cta: "Assinar Agora!",
    period: "por mês",
    href: process.env.NEXT_PUBLIC_STRIPE_PRICE_URL_MENSAL,
  ...
  },
  {
    ...
    cta: "Assinar Agora!",
    period: "por mês",
    href: process.env.NEXT_PUBLIC_STRIPE_PRICE_URL_SEMESTRAL,
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {PRICING_PLANS.map((plan, index) => (
            ...
            >
              {plan.popular && (
                <div className="absolute -top-4 left-1/2 -translate-x-1/2 bg-gradient-to-r from-cyan-500 to-blue-600 px-4 py-2 rounded-full text-white text-sm font-semibold card-elevation-2">
                  Mais Popular
                </div>
              )}
